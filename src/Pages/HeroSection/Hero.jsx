    ...
    <div className="min-h-screen bg-gray-50 py-2 px-4">
      ...
      <div className="relative w-full max-w-[1000px] mx-auto my-8 px-1 sm:px-6 lg:px-8">
        ...
        >
          {/* Updated p tag */}
          <h2
            className="font-Outfit text-[3.5vw] sm:text-[3vw] md:text-[2.2vw] lg:text-[3.5vw] font-[800] 
          ...
          {/* Updated h3 tag */}
          <h3
            className="font-Outfit text-[4.5vw] sm:text-[4vw] md:text-[3.5vw] lg:text-[1.5vw] font-[500] 
